...
public class organic extends AppCompatActivity {
    TextView t1,t2;
    EditText et1;
    Button btn1;
    String over;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t2=(TextView)findViewById(R.id.view);
        et1=(EditText)findViewById(R.id.editText);
        btn1=(Button)findViewById(R.id.button4);
        final String temp=getIntent().getStringExtra("ClickedValue");
