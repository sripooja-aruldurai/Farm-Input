...
public class inorganic extends AppCompatActivity {
    EditText e1;
    TextView tv1,tv2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amir=(Button)findViewById(R.id.button6);
        pancha=(Button)findViewById(R.id.button7);
        green=(Button)findViewById(R.id.button8);
        jeeva=(Button)findViewById(R.id.button9);
        final String temp=getIntent().getStringExtra("ClickValue");
        go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final int a=Integer.parseInt(e1.getText().toString());
                if(temp.equals("Paddy")){
